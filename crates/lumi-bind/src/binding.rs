...
use lumi_core::{
    ...
    BindGroupLayoutEntry, ComputePass, Device, PipelineLayout, PipelineLayoutDescriptor, Queue,
    RenderPass, ShaderStages, SharedBindGroup, SharedBindingResource, SharedDevice,
};
use lumi_shader::Shader;
use lumi_util::HashMap;

use crate::{Bind, BindingLayoutEntry};
